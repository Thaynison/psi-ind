...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
    ...
    do {
        ...
        $sql = "UPDATE cracha " . 
                "SET nome = '$nome', aso = '$aso', funcao = '$funcao', empresa = '$empresa', liberacao = '$liberacao', otq = '$otq', taq = '$taq', nr10 = '$nr10', nr33 = '$nr33', nr35 = '$nr35', talha = '$talha', pta = '$pta', empilhadeira = '$empilhadeira', pictograma = '$pictograma', caminho_imagem = '$image_path'" .  
                "WHERE id = $id";
        $result = $connec->query($sql);
    ...
    <main>
        <section>
            <div class="buttonsitens">
                <h2>Editar dados do Colaborador: <?php echo $nome; ?>.</h2>
            </div>
        </section>
        <section>
            <div class="buttonsitens">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Atestado de Saúde Ocupacional:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Função do Colaborador:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Treinamento de Liberação de Trabalho:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Treinamento de Observador de Trabalho a Quente:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Treinamento de Trabalho a Quente:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Treinamento de NR10:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Treinamento de NR33:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Treinamento de NR35:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Treinamento de Talha Manual:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Treinamento de PTA:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Treinamento de Empilhadeira:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3-form-label">Treinamento de Pictograma:</label>
                        <div class="col-sm-6">
